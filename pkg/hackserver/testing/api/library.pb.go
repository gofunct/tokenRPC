...
func init() {
	proto.RegisterType((*Book)(nil), "com.github.gofunct.hack.testing.api.Book")
	proto.RegisterType((*ListBooksRequest)(nil), "com.github.gofunct.hack.testing.api.ListBooksRequest")
	proto.RegisterType((*ListBooksResponse)(nil), "com.github.gofunct.hack.testing.api.ListBooksResponse")
	proto.RegisterType((*GetBookRequest)(nil), "com.github.gofunct.hack.testing.api.GetBookRequest")
	proto.RegisterType((*CreateBookRequest)(nil), "com.github.gofunct.hack.testing.api.CreateBookRequest")
	proto.RegisterType((*UpdateBookRequest)(nil), "com.github.gofunct.hack.testing.api.UpdateBookRequest")
	proto.RegisterType((*DeleteBookRequest)(nil), "com.github.gofunct.hack.testing.api.DeleteBookRequest")
}
...
func (c *libraryServiceClient) ListBooks(ctx context.Context, in *ListBooksRequest, opts ...grpc.CallOption) (*ListBooksResponse, error) {
	...
	err := grpc.Invoke(ctx, "/com.github.gofunct.hack.testing.api.LibraryService/ListBooks", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *libraryServiceClient) GetBook(ctx context.Context, in *GetBookRequest, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
	err := grpc.Invoke(ctx, "/com.github.gofunct.hack.testing.api.LibraryService/GetBook", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *libraryServiceClient) CreateBook(ctx context.Context, in *CreateBookRequest, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
	err := grpc.Invoke(ctx, "/com.github.gofunct.hack.testing.api.LibraryService/CreateBook", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *libraryServiceClient) UpdateBook(ctx context.Context, in *UpdateBookRequest, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
	err := grpc.Invoke(ctx, "/com.github.gofunct.hack.testing.api.LibraryService/UpdateBook", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *libraryServiceClient) DeleteBook(ctx context.Context, in *DeleteBookRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	...
	err := grpc.Invoke(ctx, "/com.github.gofunct.hack.testing.api.LibraryService/DeleteBook", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LibraryService_ListBooks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.github.gofunct.hack.testing.api.LibraryService/ListBooks",
	}
...
func _LibraryService_GetBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.github.gofunct.hack.testing.api.LibraryService/GetBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LibraryService_CreateBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.github.gofunct.hack.testing.api.LibraryService/CreateBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LibraryService_UpdateBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.github.gofunct.hack.testing.api.LibraryService/UpdateBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LibraryService_DeleteBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.github.gofunct.hack.testing.api.LibraryService/DeleteBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _LibraryService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "com.github.gofunct.hack.testing.api.LibraryService",
