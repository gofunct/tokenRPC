...
import (
	...
	"github.com/gofunct/hack/cmd/hack-gen-type/di"
	"github.com/gofunct/hack/cmd/hack-gen-type/template"
	"github.com/gofunct/hack/pkg/gencmd"
	gencmdutil "github.com/gofunct/hack/pkg/gencmd/util"
...
func buildParams(path string, ctx *hackcmd.Ctx) (*params, error) {
